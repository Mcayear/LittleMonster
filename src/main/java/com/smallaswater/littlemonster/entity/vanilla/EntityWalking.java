...
public abstract class EntityWalking extends VanillaEntity {
    ...
    protected boolean checkJump(double dx, double dz) {
        ...
        } else if (!(this.getNetworkId() == 26)) {//  instanceof EntitySkeletonHorse
        ...
        if (this.isMovement() && !isImmobile()) {
            ...
            if (this.getServer().getMobAiEnabled()) {
                if (this.followTarget != null && !this.followTarget.closed && this.followTarget.isAlive() && this.followTarget.canBeFollowed()) {
                    ...
                    // instanceof EntityLlama
                    if ((this.passengers.isEmpty() || this.getNetworkId() == 29) && (this.stayTime <= 0 || Utils.rand())) {
